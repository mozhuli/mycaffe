...
caffe.set_mode_gpu()
net = caffe.Net(caffe_root + 'models/test_for_diff_model/vgg_origin_0/deploy.prototxt',
                caffe_root + 'models/test_for_diff_model/vgg_origin_0/vgg16_origin.caffemodel',
                caffe.TEST)
